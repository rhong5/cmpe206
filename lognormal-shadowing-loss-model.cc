  ...
  static TypeId tid = TypeId ("ns3::LogNormalPropagationLossModel")
    ...
    .AddAttribute ("ReferenceDistance",
     ...
     .AddAttribute ("ReferenceLoss",
               ...
               MakeDoubleChecker<double> ())
      .AddAttribute ("RandomNormalVariable",
                   "The normal random variable for generating Gaussian Noise",
                                                ...
                                                Ptr<MobilityModel> b) const
{
  ...
  //----------------------------------------
  //Get Random Variable for Gaussian Noise
  double gaussRandomVar = m_randVariable->GetValue();
  // Get distance
  ...
  if (distance <= m_referenceDistance)
{
  ...
  // Path Loss equation for Shadowing
  double PL  = (10*m_exponent*std::log10(distance/m_referenceDistance))-gaussRandomVar;
  double rxc = -m_referenceLoss-PL;
