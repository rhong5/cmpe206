...
main (int argc, char *argv[])
{
  bool verbose = true;
  uint32_t nCsma = 3;
  uint32_t nWifi = 17;  //Raymond's ID = 009957389 -> 9+9 = 18
  bool tracing = false;
  ...
  ApplicationContainer serverApps = echoServer.Install (wifiStaNodes.Get(nWifi-16));
  ...
  oss <<
  "/NodeList/" << wifiStaNodes.Get (nWifi - 16)->GetId () <<
